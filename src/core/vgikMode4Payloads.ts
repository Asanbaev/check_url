export function getVgikMode4Step1Payload(): Record<string, string> {
  return {
    ...
    "user_forms[0][question11216022]": "Вадимовна",
    "user_forms[0][question11216023]": "18918490730",
    "user_forms[0][question11216024]": "8022494594",
    "user_forms[0][question11216025]": "18 лет",
    "user_forms[0][question11216026]": "Уфа",
    "user_forms[0][question11216027]": "+79374745034",
    "user_forms[0][mail]": "sofaasanbai@gmail.com",
    payment_method: "yandex_sbp",
    subscribe_digest: "on",
    accepted_terms: "on",
    "tickets[0][re_id]": "8116058",
    locale: "ru",
    "aux[use_ticket_remind]": "1",
    referer: "https://priemvgik.timepad.ru/event/3976144/",
    ...
    "stat_metadata[widget_consumer_url]": "https://priemvgik.timepad.ru/event/3976144/",
